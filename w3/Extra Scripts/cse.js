(function(opts_) {
    ...
    var b = document.createElement("script"),
        ...
        f = window.__gcse;
    if (!f || !f.plainStyle)
        var g = opts_.protocol + (opts_.uiOptions && opts_.uiOptions.enableMobileLayout ? "://www.google.com/cse/static/style/look/mobile/" : "://www.google.com/cse/static/style/look/") + opts_.theme.toLowerCase().replace("v2_", "v2/") + ".css",
            e = e + (',"style":"' + g + '"');
    ...
    "loaderPath": "jsapi",
    "cse_token": "AOdTmaAzMm3TEnGWfFj5FGz-MItjyZGvGg:1517517795330",
    "isHostedPage": false
});
